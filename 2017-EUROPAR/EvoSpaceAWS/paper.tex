...
% EA Paramaters 
Like any other EAs, the performance of the complete search will depend
on the correct tuning of the EA parameters. 
% Worst on many workers
In this case this problem  can be magnified by a factor of $N$, 
the number of workers and by other parameters particular to the 
EvoSpace framework, for instance the size of the samples. 
% Explore and Exploit
