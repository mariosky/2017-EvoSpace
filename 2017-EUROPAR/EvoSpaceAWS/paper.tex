...
\begin{figure*}[t]
    ...
    \subfigure [2 workers]
    {
        \includegraphics[width=2in]{img/2w_onemax_100_box.png}
    }
    \subfigure  [6 workers]
    {
        \includegraphics[width=2in]{img/6w_onemax_100_box.png}
    }
    \subfigure  [12 workers]
    {
        \includegraphics[width=2in]{img/12w_onemax_100_box.png}
    }
