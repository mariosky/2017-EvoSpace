...
we must select the best configuration found after from generating a 100 random parametrizations 
...
selected first because is not computationaly demanding, and more experiments where cunducted for
the tuning fase, tuning the paramenters using 2, 6, and 12 worker configurations. 
