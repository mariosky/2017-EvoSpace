...
\begin{figure*}[t]
    \centering
        \includegraphics[width=5in]{img/one_max_comp.png}
    \caption{Comparation of  }
...
\begin{figure*}[b]
    \centering
    \subfigure  [Heterogeneous configuration]
    {
        \includegraphics[width=2.2in]{img/griewank_evals_hetereo.png}
    }
    \subfigure  [Homogeneous configuration]
    {
    ...
    Box-plot of the number of evaluations needed for solution, with an (a) Heterogeneous configuration, and (b) Homogeneous configuration.}
