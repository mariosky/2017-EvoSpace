...
\subsection{{\sf evospace-js} Population Repository} % Maybe qualify this, it's got the same
                               ...
                               % the begining and other papers, will stick to that.
\label{sec:evospace}
...
The whole experiment (all dimensions and instances) took 
less three hours to execute. The results obtained show that the 
